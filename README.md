...
<p align="center"><img src="https://tupian.li/images/2023/11/19/65599097aba8e.png" alt="截图编辑模式.png" style="width: 80%;"></p>

**截图编辑模式**：截图后不会立即识别，而是保留选区框，允许微调后再确认。
